...
namespace Galileo.Utils.ASTMModel
{
    ...
    public class ManufacturerTestObject
    {
    ...
    public class ManufacturerDataMeasurementObject
    {
        public string Value;
    ...
    {
        public ManufacturerRecord(string content, MessageHeader header)
        {
            ...
            if (parms.Length > 2)
            {
                ...
                this.TestIdentifier = new ManufacturerTestObject();
            ...
            if (parms.Length > 3)
            {
                ...
                this.DataMeasurement = new ManufacturerDataMeasurementObject();
        ...
        public ManufacturerTestObject TestIdentifier;
        public ManufacturerDataMeasurementObject DataMeasurement;
